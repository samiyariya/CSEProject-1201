...
void mousehandling_middle()
{
    ...
    // continue
    if (mouse_x >= 10 && mouse_x <= mWidth && mouse_y >= (SCREEN_HEIGHT / 2) - 50 && mouse_y <= (SCREEN_HEIGHT / 2) - 50 + mHeight - 15)
    {
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
            ...
            {
                Mix_HaltMusic();
                Mix_PlayMusic(zombiemsound, -1);
                sound = false;
            }
        }
    }
    // newgame
    if (mouse_x >= 10 && mouse_x <= 10 + mWidth && mouse_y >= (SCREEN_HEIGHT / 2) + 15 && mouse_y <= (SCREEN_HEIGHT / 2) + mHeight - 15)
    {
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
            Mix_PlayChannel(-1, mouseclick, 0);
    ...
    // highscore
    if (mouse_x >= 10 && mouse_x <= mWidth && mouse_y >= (SCREEN_HEIGHT / 2) + 100 + 15 && mouse_y <= (SCREEN_HEIGHT / 2) + 100 + mHeight - 15)
    {
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
            Mix_PlayChannel(-1, mouseclick, 0);
    ...
    // help
    if (mouse_x >= 10 && mouse_x <= 10 + mWidth - 180 && mouse_y >= (SCREEN_HEIGHT / 2) + 50 + 15 && mouse_y <= (SCREEN_HEIGHT / 2) + 50 + mHeight - 20)
    {
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
            Mix_PlayChannel(-1, mouseclick, 0);
    ...
    // exit
    if (mouse_x >= 10 && mouse_x <= 10 + mWidth - 180 && mouse_y >= (SCREEN_HEIGHT / 2) + 150 + 10 && mouse_y <= (SCREEN_HEIGHT / 2) + 150 + mHeight - 10)
    {
        // int menuSelect=0;
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
...
void mousehandling_start()
{
    ...
    buttons = SDL_GetMouseState(&mouse_x, &mouse_y);
    // newgame
    if (mouse_x >= 10 && mouse_x <= 10 + mWidth && mouse_y >= (SCREEN_HEIGHT / 2) && mouse_y <= (SCREEN_HEIGHT / 2) - 20 + mHeight)
    {
        if (buttons & SDL_BUTTON(SDL_BUTTON_LEFT))
        {
            Mix_PlayChannel(-1, mouseclick, 0);
