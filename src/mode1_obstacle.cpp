...
void obstacle()
{
    ...
    if (x_pos + 35 >= obs_x1 && x_pos + 35 <= obs_x1 + obs_x1_width && !((y_pos + 145) < 460))
    {
        alive--;
        if (score >= 10 && alive > 1)
            score = score - 10;
    ...
    if (x_pos + 35 >= obs_x2 && x_pos + 35 <= obs_x2 + obs_x2_width && !((y_pos + 145) < 460))
    {
        alive--;
        if (score >= 10 && alive > 1)
            score = score - 10;
    ...
    if (x_pos + 35 >= obs_x3 && x_pos + 35 <= obs_x3 + obs_x3_width && !((y_pos + 145) < 460))
    {
        alive--;
        if (score >= 10 && alive > 1)
            score = score - 10;
