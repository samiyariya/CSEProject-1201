...
void dog_sprite()
{
    ...
    dog_spriteclips[0].w = width / 6;
    dog_spriteclips[0].h = height;

    dog_spriteclips[1].x = 0;
    dog_spriteclips[1].y = 0;
    dog_spriteclips[1].w = width / 6;
    dog_spriteclips[1].h = height;

    dog_spriteclips[2].x = 0;
    dog_spriteclips[2].y = 0;
    dog_spriteclips[2].w = width / 6;
    dog_spriteclips[2].h = height;

    dog_spriteclips[3].x = width - (width / 6) * 5;
    dog_spriteclips[3].y = 0;
    dog_spriteclips[3].w = width / 6;
    dog_spriteclips[3].h = height;

    dog_spriteclips[4].x = width - (width / 6) * 5;
    dog_spriteclips[4].y = 0;
    dog_spriteclips[4].w = width / 6;
    dog_spriteclips[4].h = height;

    dog_spriteclips[5].x = width - (width / 6) * 5;
    dog_spriteclips[5].y = 0;
    dog_spriteclips[5].w = width / 6;
    dog_spriteclips[5].h = height;

    dog_spriteclips[6].x = width - (width / 6) * 4;
    dog_spriteclips[6].y = 0;
    dog_spriteclips[6].w = width / 6;
    dog_spriteclips[6].h = height;

    dog_spriteclips[7].x = width - (width / 6) * 4;
    dog_spriteclips[7].y = 0;
    dog_spriteclips[7].w = width / 6;
    dog_spriteclips[7].h = height;

    dog_spriteclips[8].x = width - (width / 6) * 4;
    dog_spriteclips[8].y = 0;
    dog_spriteclips[8].w = width / 6;
    dog_spriteclips[8].h = height;

    dog_spriteclips[9].x = width - (width / 6) * 3;
    dog_spriteclips[9].y = 0;
    dog_spriteclips[9].w = width / 6;
    dog_spriteclips[9].h = height;

    dog_spriteclips[10].x = width - (width / 6) * 3;
    dog_spriteclips[10].y = 0;
    dog_spriteclips[10].w = width / 6;
    dog_spriteclips[10].h = height;

    dog_spriteclips[11].x = width - (width / 6) * 3;
    dog_spriteclips[11].y = 0;
    dog_spriteclips[11].w = width / 6;
    dog_spriteclips[11].h = height;

    dog_spriteclips[12].x = width - (width / 6) * 2;
    dog_spriteclips[12].y = 0;
    dog_spriteclips[12].w = width / 6;
    dog_spriteclips[12].h = height;

    dog_spriteclips[13].x = width - (width / 6) * 2;
    dog_spriteclips[13].y = 0;
    dog_spriteclips[13].w = width / 6;
    dog_spriteclips[13].h = height;

    dog_spriteclips[14].x = width - (width / 6) * 2;
    dog_spriteclips[14].y = 0;
    dog_spriteclips[14].w = width / 6;
    dog_spriteclips[14].h = height;

    dog_spriteclips[15].x = width - (width / 6) * 1;
    dog_spriteclips[15].y = 0;
    dog_spriteclips[15].w = width / 6;
    dog_spriteclips[15].h = height;

    dog_spriteclips[16].x = width - (width / 6) * 1;
    dog_spriteclips[16].y = 0;
    dog_spriteclips[16].w = width / 6;
    dog_spriteclips[16].h = height;

    dog_spriteclips[17].x = width - (width / 6) * 1;
    dog_spriteclips[17].y = 0;
    dog_spriteclips[17].w = width / 6;
    dog_spriteclips[17].h = height;
}
...
void setup_enemy()
{
    ...
    enemy[DOG].body.y = 340;
    enemy[DOG].body.w = 120;
    enemy[DOG].body.h = 160;
    enemy[DOG].speed = 0;
    enemy[DOG].lives = 1;

    enemy[ZOMBIE].body.x = 1200;
    enemy[ZOMBIE].body.y = 340;
...
void enemies()
{
    ...
    if (x_pos + 35 >= enemy[DOG].body.x && x_pos + 35 <= enemy[DOG].body.x + enemy[DOG].body.w && !((y_pos + 115) < 380))
    {
